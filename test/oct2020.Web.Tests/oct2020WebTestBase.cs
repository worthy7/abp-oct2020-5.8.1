...
{
    public abstract class oct2020WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static oct2020WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(oct2020WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<oct2020DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<oct2020DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<oct2020DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<oct2020DbContext, Task<T>> func)
        {
            T result;
