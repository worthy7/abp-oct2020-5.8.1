...
namespace oct2020.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly oct2020DbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = oct2020Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(oct2020DbContext context)
        {
            _context = context;
        }
